...
#region UI & Personalization #PATS EDIT
...
# Show seconds on taskbar clock #PATS EDIT
# Отображать секунды в системных часах на панели задач
# New-ItemProperty -Path HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced -Name ShowSecondsInSystemClock -PropertyType DWord -Value 1 -Force

# Do not show when snapping a window, what can be attached next to it #PATS EDIT
...
# Show the Ribbon expanded in File Explorer #PATS EDIT
...
# Always show all icons in the notification area #PATS EDIT
...
# Set the large icons in the Control Panel #PATS EDIT
...
# Turn on Windows 10 20H2 new Start style #PATS EDIT
...
switch ($Result)
{
	"0"
	{
		...
		<##>#PATS EDIT vv To be commented back in for default behavior
...
"@
		...
		<##>#PATS EDIT ^^ To be commented back in for default behavior
	}
	"1"
	{
		if ($RU)
...
{
	Write-Verbose -Message "Windows edition mus be Pro for Windows Sandbox" -Verbose
}
...
# Turn on automatically save my restartable apps when sign out and restart them after sign in #PATS EDIT
...
## Pats
# # Show the "File Explorer" and "Settings" folders in Start Menu
...
# PATS EDIT - Checks to see if syspin.exe is there
...
# if ($syspin -eq $true) #PATS EDIT - I Dont want anything pinned to start
# {
...
$UncheckedAppxPackages = @(
	...
	# Sticky Notes
	# Записки
	# "Microsoft.MicrosoftStickyNotes" #PATS EDIT - I Dont use sticky notes
	# Windows Camera
	"Microsoft.WindowsCamera" #PATS EDIT - I use the camera sometimes
	"Microsoft.MSPaint" #PATS EDIT
